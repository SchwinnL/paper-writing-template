...
%knowledge of the optimization problem, e.g., about the underlying functions $f$, 2) constraints, e.g., perturbation budgets, and 3) the required computational effort. 
